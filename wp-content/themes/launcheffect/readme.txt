...
= 2.43 =
* [Major Fix] Stats page not compatible with WP 4.2.1
* [New Feature] Background image displays on mobile and tablet devices
* [New Feature] Send signup notifications to another email
* [Improvement] Add Referral link to Admin > Individual Stats page
* [Improvement] General code cleanup
* [Fix] WP audio shortcode didn’t work on Launch Template or Sign-Up Body Content.
* [Fix] Admin Email not displaying HTML symbols
* [Fix] If a signup is deleted, the original referrer’s conversion didn’t get removed
* [Fix] Stats page pagination not working
