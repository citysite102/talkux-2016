...
$placed_content = '<div id="signup-editor-content">'. apply_filters( 'the_content', get_the_content()) .'</div>';
?>
				...
				<div id="signup-content-wrapper">
					...
					<div id="signup-body">
						...
						<div id="presignup-content" class="signup-left">
							...
							<?php if($description_content = ler('description_content')) echo do_shortcode(wpautop($description_content)); ?>
						...
						<div id="success-content">
							...
							<?php if($description_content2 = ler('description_content2')) echo do_shortcode(wpautop($description_content2)); ?>
