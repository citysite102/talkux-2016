...
'selectarray' => array('At Top', 'After Logo', 'After Video', 'After Progress Indicators', 'After Subheading', 'After Body Text', 'After Sign-Up Form', 'At Bottom'),
		...
		'Additional Settings' => array(
			array( // subsection
				...
				array(
					'label' => 'Send Signup Notification to Another Email',
					'type' => 'check',
					'option_name' => 'lefx_different_notify',
					'class' => 'le-check',
					'subtype' => '',
					'desc' => '',
					'premium' => '',
				...
				array(
					'label' => 'Email Address',
					'type' => 'text',
					'option_name' => 'lefx_different_notify_email',
					'class' => 'le-input',
					'subtype' => '',
					'desc' => 'To notify someone other than the Admin when a user has signed up, enter their email address here. Separate multiple emails with a comma.',
					'premium' => '',
					'std' => ''
				)				
			),
