...
class Custom_List_Table extends WP_List_Table {
	var $_sort_columns, $_bulk_actions, $_query, $_where, $_search, $_table_name, $_columns;
	...
	function prepare_items() {
	    ...
	    $orderby = !empty($_GET["orderby"]) ? addslashes($_GET["orderby"]) : 'TIME';
	    $order = !empty($_GET["order"]) ? addslashes($_GET["order"]) : 'DESC';
	 ...
	 */
	public function single_dark_row( $item ) {
